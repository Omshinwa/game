label label_handjob:
    ...
    j "Here's a hint"
    show handjob-start-hint as joyce with dissolve
    window hide
    pause
    window auto
    j "So, did you guess?"
...
label label_handjob_SexEndTurn:
    ...
    if date.isLost():
        ...
        "i'm gonna cum!"
        stop sound
        if "handjobv2" in renpy.get_attributes("joyce"):
            show expression "handjob v2 (1)" as joyce
        else:
            show expression "handjob (1)" as joyce
        pause 0.2
