...
screen layered_image_visualizer(demonstration=False):
    ...
    vbox:
        ...
        use sprt_viewport_layered id "sprt_viewport"
        hbox:
        ...
        if not dev_hide_groups:
            ...
            hbox:
                ...
                for g in sorted(persistent.current_layeredimage_groups.get(
                        persistent.sprt_who, [])):
                    textbutton g:
                        action [SetDict(persistent.sprt_included_layeredimage_groups, persistent.sprt_who, [g])] 
                        alternate ToggleSetMembership(persistent.sprt_included_layeredimage_groups.setdefault(persistent.sprt_who, list()), g) ##fynedit
                        selected g in persistent.sprt_included_layeredimage_groups.setdefault(persistent.sprt_who, list())
