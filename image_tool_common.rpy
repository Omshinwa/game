...
## your project better.
define sprt.BIG_TEXT = int(gui.text_size*1.4)*0.5
define sprt.MED_TEXT = gui.text_size*0.5
define sprt.SMALL_TEXT = int(gui.text_size*0.8)*0.5
...
## The viewport that shows the image FYNEDIT for the layered
screen sprt_viewport_layered(demonstration=False, tinted=False):
    ...
    vbox:
        ...
        if sprt.construct_image_attributes(persistent.sprt_who) and not demonstration:
