...
screen screen_buttons_ui():
    ...
    fixed:
        ...
        #     sensitive game.jeu_sensitive
        textbutton _("END {size=60}TURN") at Transform(None,rotate=-90):
            ...
            action Call(date.endTurn)
            sensitive game.jeu_sensitive
            # text_outlines [ (absolute(5), "#ffffff", absolute(0), absolute(3)) ]
            text_style "quirky_command"
            text_hover_color "#25d7ff"
            text_kerning -5
            
            text_outlines [ (8, "#181d2899", -10, 0), (10, gui.hover_color, 0, 0), (5, "#000000", 0, 0) ]
