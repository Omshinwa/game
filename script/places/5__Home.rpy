...
label label_home_cat:
    ...
    if game.progress[0]<2:
        menu:
            "talk to it":
                call label_home_add_cards("chat", "Add a Chat to your deck?") from _call_label_home_add_cards_1
            "stare at it":
        ...
        menu:
            "talk to it":
                call label_home_add_cards("chat", "Add a Chat to your deck?") from _call_label_home_add_cards_3
            "stare at it":
...
label label_home_comp:
    ...
    if game.debug_mode:
        menu:
            ...
            "Post messages":
                call label_transform_card("chat", "ask", "Transform 1 Chat card into Ask?", "label_home") from _call_label_transform_card
            "Read messages":
                call label_transform_card("chat", "listen", "Transform 1 Chat card into Listen?", "label_home") from _call_label_transform_card_1
            "go to prison":
                jump label_prison 
            "X":
                return
        ...
        menu:
            "You log in."
            "Post messages":
                call label_transform_card("chat", "ask", "Transform 1 Chat card into Ask?", "label_home") from _call_label_transform_card_2
            "Read messages":
                call label_transform_card("chat", "listen", "Transform 1 Chat card into Listen?", "label_home") from _call_label_transform_card_3
            "X":
                return
    return
