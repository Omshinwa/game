label label_bubbleTea:
    ...
    show joyce outfit1 smile at trs_sitting, trs_lighting_bbt
    ...
    label .gameLoop:
        ...
        label .winCondition:
            if date.isWin():
                ...
                j happy "I liked hanging out with you, we should do that more."
                j -smile eyeside "Though it's getting quite warm these days!"
                j smile -eyeside "We should enjoy our drinks outdoors next time!"
...
label label_bubbleTea_endTurn:
    ...
    if game.progress[1]<=1:
        if date.turn == 1:
            ...
            pause 2.0
            show joyce outfit1 smile at trs_standing, trs_lighting_bbt with dissolve
