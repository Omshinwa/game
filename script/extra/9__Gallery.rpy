...
screen screen_gallery_replay():
    # RELEASE you gotta change all the Call() into Replay()
    fixed:
        ...
        vpgrid cols 4 rows 3:
            ...
            textbutton "handjob" action Replay("label_handjob") style "style_text_button" text_color "#fff" text_hover_color gui.hover_color
            textbutton "titjob" action Replay("label_titjob") style "style_text_button" text_color "#fff" text_hover_color gui.hover_color
            textbutton "blowjob" action Replay("label_blowjob") style "style_text_button" text_color "#fff" text_hover_color gui.hover_color
            textbutton "cowgirl" action Replay("label_cowgirl") style "style_text_button" text_color "#fff" text_hover_color gui.hover_color
...
screen screen_replay(label):
    ...
    vbox:
        ...
        textbutton _("CUM") action Call("label_replay_btn_goto", label + "_Lost")
        textbutton _("Win") action Call("label_replay_btn_goto", label + "_Win")
